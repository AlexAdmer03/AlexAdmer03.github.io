...
export function collide(ball1, ball2) {
    try {
        ...
        wasm.collide(retptr, ball1.__wbg_ptr, ball2.__wbg_ptr);
...
* @returns {Float64Array}
*/
export function batch_collide(masses, velocities, count) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayF64ToWasm0(masses, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF64ToWasm0(velocities, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.batch_collide(retptr, ptr0, len0, ptr1, len1, count);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
export class Ball {
    ...
    * @returns {Ball}
    */
    static new(mass, velocity) {
        const ret = wasm.ball_new(mass, velocity);
    ...
    */
    velocity() {
        const ret = wasm.ball_velocity(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('collision_simulation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
